...
rst -processor
targets -set -nocase -filter {name =~ "microblaze*#0" && bscan=="USER2"  && jtag_cable_name =~ "Digilent Arty A7-35T 210319AE169CA"} -index 0
dow C:/Users/zacharyheil/Desktop/embedded-systems-soc/embedded-systems-soc.sdk/hello-world_bsp_xgpio_intr_tapp_example_1/Debug/hello-world_bsp_xgpio_intr_tapp_example_1.elf
bpadd -addr &main
